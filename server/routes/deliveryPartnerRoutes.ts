...
import { cancelDelivery, completeDelivery, getDeliveryDetail, getMyDeliveries, loginPartner, updateDeliveryStatus, updateLocation } from "../controllers/deliveryPartnerContoller.js";
...
deliveryPartnerRouter.put('/my-deliveries/:id/status', deliveryAuth, updateLocation)
