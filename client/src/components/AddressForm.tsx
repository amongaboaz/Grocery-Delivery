...
const AddressForm = ({resetForm, handleSubmit, form, setForm,
    editingId} : any) => {
...
<div className="grid grid-cols-2 gap-3">
<div><label className="block text-sm font-medium text-app-green mb-1.5">
                Zip Code
                  </label>
...
<label className="flex items-center gap-2 cursor-pointer">
    ...
    />
              ...
              {/* submit button */}
              <button type="submit" className="mt-6 w-full py-3 bg-app-green text-white font-semibold rounded-xl hover:bg-app-green-light transition-colours">
