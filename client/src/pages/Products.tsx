    ...
    <div className="flex items-center justify-between mb-6">
      ...
      <div className="flex flex-col lg:items-center gap-3">
          ...
          <button 
            ...
            className="lg:hidden flex items-center gap-2 px-3 py-2 bg-white rounded-xl border border-app-border hover:bg-app-bg transition-colors"
          >
