...
{loading ? (
  ...
  <span
    className={`flex items-center gap-1 px-4 py-1 text-xs font-medium rounded-full ${
  ...
  <ChevronRightIcon className="size-4 text-app-text-light" />
    ...
    sm:size-16 rounded-lg bg-app-cream flex items-center justify-center text-xs
